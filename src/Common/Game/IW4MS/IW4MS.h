...
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetPhysPreset, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetPhysCollMap, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetXAnim, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetXModelSurfs, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetXModel, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetMaterial, info.name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetPixelShader, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetVertexShader, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetVertexDecl, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetTechniqueSet, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetImage, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetSound, aliasName);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetSoundCurve, filename);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetLoadedSound, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetClipMapSp, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetClipMapMp, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetComWorld, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetGameWorldSp, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetGameWorldMp, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetMapEnts, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetFxWorld, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetGfxWorld, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetLightDef, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetFont, fontName);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetMenuList, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetMenu, window.name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetLocalize, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetWeapon, szInternalName);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetFx, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetImpactFx, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetRawFile, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetStringTable, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetLeaderboard, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetStructuredDataDef, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetTracer, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetVehicle, name);
DEFINE_ASSET_NAME_ACCESSOR(IW4MS::AssetAddonMapEnts, name);
