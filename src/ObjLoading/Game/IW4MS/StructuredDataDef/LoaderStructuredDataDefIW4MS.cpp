#include "LoaderStructuredDataDefIW4MS.h"
...
{
    std::unique_ptr<AssetCreator<AssetStructuredDataDef>> CreateLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath)
    {
