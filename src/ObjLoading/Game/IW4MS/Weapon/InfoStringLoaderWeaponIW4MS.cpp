#include "InfoStringLoaderWeaponIW4MS.h"

#include "Game/IW4MS/IW4MS.h"
#include "Game/IW4MS/InfoString/EnumStrings.h"
#include "Game/IW4MS/InfoString/InfoStringToStructConverter.h"
#include "Game/IW4MS/Weapon/WeaponFields.h"
...
namespace weapon
{
    InfoStringLoaderIW4MS::InfoStringLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath, Zone& zone)
        : m_memory(memory),
    ...
    AssetCreationResult InfoStringLoaderIW4MS::CreateAsset(const std::string& assetName, const InfoString& infoString, AssetCreationContext& context)
    {
