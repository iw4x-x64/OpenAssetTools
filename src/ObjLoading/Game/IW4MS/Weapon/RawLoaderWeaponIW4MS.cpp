#include "RawLoaderWeaponIW4MS.h"
...
namespace
{
    ...
    private:
        ...
        weapon::InfoStringLoaderIW4MS m_info_string_loader;
    };
} // namespace

namespace weapon
{
    std::unique_ptr<AssetCreator<AssetWeapon>> CreateRawLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath, Zone& zone)
    {
