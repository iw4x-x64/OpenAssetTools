#include "LightDefLoaderIW4MS.h"

#include "Game/IW4MS/IW4MS.h"
#include "Game/IW4MS/LightDef/LightDefAssetCreationStateIW4MS.h"
...
namespace light_def
{
    std::unique_ptr<AssetCreator<AssetLightDef>> CreateLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath)
    {
