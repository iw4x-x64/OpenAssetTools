#include "RawLoaderPhysPresetIW4MS.h"
...
{
    std::unique_ptr<AssetCreator<AssetPhysPreset>> CreateRawLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath, Zone& zone)
    {
