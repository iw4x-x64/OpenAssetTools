#include "LoaderMaterialIW4MS.h"

#include "Game/IW4MS/IW4MS.h"
#include "Game/IW4MS/Material/JsonMaterialLoaderIW4MS.h"
...
namespace material
{
    std::unique_ptr<AssetCreator<AssetMaterial>> CreateLoaderIW4MS(MemoryManager& memory, ISearchPath& searchPath)
    {
