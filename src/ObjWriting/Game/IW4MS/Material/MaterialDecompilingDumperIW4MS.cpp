#include "MaterialDecompilingDumperIW4MS.h"

#include "Game/IW4MS/MaterialConstantsIW4MS.h"
#include "Game/IW4MS/ObjConstantsIW4MS.h"
#include "Game/IW4MS/Techset/TechsetConstantsIW4MS.h"
...
namespace material
{
    void DecompilingGdtDumperIW4MS::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetMaterial::Type>& asset)
    {
        if (!context.m_gdt)
            return;
