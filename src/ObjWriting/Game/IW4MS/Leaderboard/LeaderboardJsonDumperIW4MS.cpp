#include "LeaderboardJsonDumperIW4MS.h"

#include "Game/IW4MS/CommonIW4MS.h"
#include "Game/IW4MS/Leaderboard/JsonLeaderboardDef.h"
...
{
    void JsonDumperIW4MS::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetLeaderboard::Type>& asset)
    {
