#include "WeaponDumperIW4MS.h"

#include "Game/IW4MS/CommonIW4MS.h"
#include "Game/IW4MS/InfoString/EnumStrings.h"
#include "Game/IW4MS/InfoString/InfoStringFromStructConverter.h"
...
namespace weapon
{
    void DumperIW4MS::DumpAsset(AssetDumpingContext& context, const XAssetInfo<AssetWeapon::Type>& asset)
    {
